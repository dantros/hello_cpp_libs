// Extracted from: https://github.com/BehaviorTree/BehaviorTree.CPP/blob/master/examples/t01_build_your_first_tree.cpp
// Note: in the Visual Studio solution, you only need to build behaviortree_cpp_v3.
